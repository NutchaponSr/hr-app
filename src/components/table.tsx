              ...
              return (
                columnMatched ? (
                  ...
                  <th 
                    key={header.id}
                    className={cn(
                      "sticky top-8 z-20 bg-sidebar px-3 start-0 h-8 shadow-[inset_0_1.25px_0_rgba(42,28,0,0.07),inset_0_-1.25px_0_rgba(42,28,0,0.07)] dark:shadow-[inset_0_1.25px_0_rgba(255,255,243,0.082),inset_0_-1.25px_0_rgba(255,255,243,0.082)] border-r-[1.25px] border-border",
