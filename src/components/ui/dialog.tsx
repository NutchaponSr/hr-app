...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-base leading-6 font-semibold text-primary text-center text-pretty", className)}
      {...props}
    />
  )
}
