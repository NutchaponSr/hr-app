...
import { CultureItem } from "@/generated/prisma";
...
export const CultureCellInput = ({
  ...
  const processFieldValue = useCallback((fieldName: keyof CultureItem, rawValue: string): KpiFieldValue => {
    try {
