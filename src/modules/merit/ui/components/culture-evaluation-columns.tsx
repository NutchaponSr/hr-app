...
export const createColumns = ({ hasChecker, form, permissions }: Props): ColumnDef<CultureWithInfo>[] => {
  const baseColumns: ColumnDef<CultureWithInfo>[] = [
    {
      id: "culture",
      header: "Culture",
      cell: ({ row }) => (
  ...
  const checkerColumn: ColumnDef<CultureWithInfo> = {
    id: "checker",
    header: "Checker",
    cell: ({ row, table }) => (
      <div className="flex flex-col gap-2">
  ...
  const tailColumns: ColumnDef<CultureWithInfo>[] = [
    {
      id: "approver",
      header: "Approver",
      cell: ({ row, table }) => (
